...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.12/),
...
[Unreleased]: https://github.com/cumulus13/win-ifconfig/compare/v1.0.12...HEAD
[1.0.5]: https://github.com/cumulus13/win-ifconfig/releases/tag/v1.0.12
